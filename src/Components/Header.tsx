...
interface HeaderProps {
    toggleProjects: () => void; // تعريف الدالة toggleProjects كخاصية
  }
      ...
      <header className="bg-gray-600 text-white p-4 fixed top-0 w-full z-50">
        <div className="flex justify-between items-center max-w-6xl mx-auto px-4">
          <div className="flex space-x-4">
            ...
            <a href="https://wa.me/yourphonenumber" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
              <img src={whatsapp} alt="WhatsApp" className="h-8 w-8" />
            </a>
            <a href="https://www.youtube.com/channel/yourchannel" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400">
